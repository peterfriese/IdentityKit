...
/// Since IdentityKit is a static framework, the bundle containing the resources is copied into the final product.
    nonisolated static let module: Bundle = {
        let bundleName = "IdentityKit_IdentityKit"
        ...
        fatalError("unable to find bundle named IdentityKit_IdentityKit")
    }()
}
// MARK: - Objective-C Bundle Accessor
@objc
public final class IdentityKitResources: NSObject {
